      ...
      <div className='country-details__properties-list'>
        <div className='country-details__properties-list-main'>
          ...
          <p className='country-details__population country-details__property'>
            <span className='country-details__property-title'>Population:</span>
            <span className='country-details__property-value'>
              {population.toLocaleString('en-US')}
            </span>
          </p>
          <p className='country-details__region country-details__property'>
            <span className='country-details__property-title '>Region:</span>
            <span className='country-details__property-value'>{region}</span>
          </p>
          <p className='country-details__sub-region country-details__property'>
            <span className='country-details__property-title'>Sub Region:</span>
            <span className='country-details__property-value'>{subregion}</span>
          </p>
          <p className='country-details__capital country-details__property'>
            <span className='country-details__property-title '>Capital:</span>
            <span className='country-details__property-value'>{capital}</span>
          </p>
        </div>
        <div className='country-details__properties-list-secondary'>
          ...
          <p className='country-details__currencies country-details__property'>
            <span className='country-details__property-title'>Currencies:</span>
            <ul className='country-details__currencies-list'>
              {currenciesList}
            </ul>
          </p>
          <p className='country-details__languages country-details__property'>
            <span className='country-details__property-title'>Languages:</span>
            <ul className='country-details__languages-list'>{languagesList}</ul>
          </p>
        </div>
      </div>
